	                   ...
	                   <div class="p-4 border border-2 border-light">
		                   <div class="row g-3">
							   ...
							   <div class="col-3 text-end">
							   	   <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#memberDropBBtn">회원탈퇴</button>	
							   </div>
							   <div class="modal fade" id="memberDropBBtn" aria-labelledby="exampleModalLabel" aria-hidden="true">
