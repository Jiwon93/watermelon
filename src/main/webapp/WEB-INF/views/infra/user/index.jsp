...
<form>
	...
	<div class="container py-5">
		<div class="row ms-5 me-5">
			...
			<div class="col text-center">
				<a id="photoVideo"><i class="fa-solid fa-camera fa-4x"></i></a>
				<br><label class="text-primary" for="photoVideo"><b>사진/영상</b></label>
			</div>
		</div>
		<div class="row ms-5 me-5 mt-5">
			<div class="col text-center">
				<a id="beautyHealth"><i class="fa-solid fa-heart fa-4x"></i></a>
				<br><label class="text-primary" for="beautyHealth"><b>미용/건강</b></label>
			</div>
			<div class="col text-center">
				<a id="employ"><i class="fa-solid fa-pencil fa-4x"></i></a>
				<br><label class="text-primary" for="employ"><b>취업/입시</b></label>
			</div>
			<div class="col text-center">
				<a id="marketing"><i class="fa-solid fa-lightbulb fa-4x"></i></a>
